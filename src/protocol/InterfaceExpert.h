...
public:
    ...
    virtual void processControlOut(byte_array data) { this->m_controlPackets++; this->m_controlBytes += data.second; };
    virtual void processControlIn(byte_array data) { this->m_controlPackets++; this->m_controlBytes += data.second; };
    virtual void processBulkOut(byte_array data) { this->m_packets++; this->m_bytes += data.second; };
    virtual void processBulkIn(byte_array data) { this->m_packets++; this->m_bytes += data.second; };
